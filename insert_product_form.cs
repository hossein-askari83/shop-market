...
namespace shop_database
{
    public partial class insert_product_form : Form
    {
        ...
        private void submitbtn_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("SOME DATA TYPES IS NOT VALID", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        }
    }
}
